...
export const GROUP_STAGE_SCHEDULE: readonly GroupStageMatchRow[] = [
  ...
  { matchId: 'wc26-H-06', groupId: 'H', teamHomeId: 'CPV', teamAwayId: 'KSA', scheduledAt: '2026-06-26T19:00:00.000Z' },
  // —— Group I ——
  { matchId: 'wc26-I-01', groupId: 'I', teamHomeId: 'FRA', teamAwayId: 'SEN', scheduledAt: '2026-06-16T22:00:00.000Z' },
  { matchId: 'wc26-I-02', groupId: 'I', teamHomeId: 'IRQ', teamAwayId: 'NOR', scheduledAt: '2026-06-16T19:00:00.000Z' },
  { matchId: 'wc26-I-03', groupId: 'I', teamHomeId: 'FRA', teamAwayId: 'IRQ', scheduledAt: '2026-06-22T22:00:00.000Z' },
  { matchId: 'wc26-I-04', groupId: 'I', teamHomeId: 'NOR', teamAwayId: 'SEN', scheduledAt: '2026-06-22T19:00:00.000Z' },
  { matchId: 'wc26-I-05', groupId: 'I', teamHomeId: 'FRA', teamAwayId: 'NOR', scheduledAt: '2026-06-26T22:00:00.000Z' },
  { matchId: 'wc26-I-06', groupId: 'I', teamHomeId: 'SEN', teamAwayId: 'IRQ', scheduledAt: '2026-06-26T19:00:00.000Z' },
  // —— Group J ——
  { matchId: 'wc26-J-01', groupId: 'J', teamHomeId: 'ARG', teamAwayId: 'ALG', scheduledAt: '2026-06-16T22:00:00.000Z' },
  { matchId: 'wc26-J-02', groupId: 'J', teamHomeId: 'AUT', teamAwayId: 'JOR', scheduledAt: '2026-06-16T19:00:00.000Z' },
  { matchId: 'wc26-J-03', groupId: 'J', teamHomeId: 'ARG', teamAwayId: 'AUT', scheduledAt: '2026-06-22T22:00:00.000Z' },
  { matchId: 'wc26-J-04', groupId: 'J', teamHomeId: 'JOR', teamAwayId: 'ALG', scheduledAt: '2026-06-22T19:00:00.000Z' },
  { matchId: 'wc26-J-05', groupId: 'J', teamHomeId: 'ARG', teamAwayId: 'JOR', scheduledAt: '2026-06-27T22:00:00.000Z' },
  { matchId: 'wc26-J-06', groupId: 'J', teamHomeId: 'ALG', teamAwayId: 'AUT', scheduledAt: '2026-06-27T19:00:00.000Z' },
  // —— Group K ——
  { matchId: 'wc26-K-01', groupId: 'K', teamHomeId: 'POR', teamAwayId: 'COD', scheduledAt: '2026-06-17T22:00:00.000Z' },
  { matchId: 'wc26-K-02', groupId: 'K', teamHomeId: 'UZB', teamAwayId: 'COL', scheduledAt: '2026-06-17T19:00:00.000Z' },
  { matchId: 'wc26-K-03', groupId: 'K', teamHomeId: 'POR', teamAwayId: 'UZB', scheduledAt: '2026-06-23T22:00:00.000Z' },
  { matchId: 'wc26-K-04', groupId: 'K', teamHomeId: 'COL', teamAwayId: 'COD', scheduledAt: '2026-06-23T19:00:00.000Z' },
  { matchId: 'wc26-K-05', groupId: 'K', teamHomeId: 'POR', teamAwayId: 'COL', scheduledAt: '2026-06-27T22:00:00.000Z' },
  { matchId: 'wc26-K-06', groupId: 'K', teamHomeId: 'COD', teamAwayId: 'UZB', scheduledAt: '2026-06-27T19:00:00.000Z' },
  // —— Group L ——
  { matchId: 'wc26-L-01', groupId: 'L', teamHomeId: 'ENG', teamAwayId: 'CRO', scheduledAt: '2026-06-17T22:00:00.000Z' },
  { matchId: 'wc26-L-02', groupId: 'L', teamHomeId: 'GHA', teamAwayId: 'PAN', scheduledAt: '2026-06-17T19:00:00.000Z' },
  { matchId: 'wc26-L-03', groupId: 'L', teamHomeId: 'ENG', teamAwayId: 'GHA', scheduledAt: '2026-06-23T22:00:00.000Z' },
  { matchId: 'wc26-L-04', groupId: 'L', teamHomeId: 'PAN', teamAwayId: 'CRO', scheduledAt: '2026-06-23T19:00:00.000Z' },
  { matchId: 'wc26-L-05', groupId: 'L', teamHomeId: 'ENG', teamAwayId: 'PAN', scheduledAt: '2026-06-27T22:00:00.000Z' },
  { matchId: 'wc26-L-06', groupId: 'L', teamHomeId: 'CRO', teamAwayId: 'GHA', scheduledAt: '2026-06-27T19:00:00.000Z' },
] as const
