...
export const WC26_KO_MATCHES: readonly KoMatchTemplate[] = [
  ...
  { matchNum: 81, round: 'r32', home: { kind: 'group_winner', group: 'B' }, away: { kind: 'third_slot', matchNum: 81 } },
  { matchNum: 82, round: 'r32', home: { kind: 'group_winner', group: 'D' }, away: { kind: 'third_slot', matchNum: 82 } },
  { matchNum: 83, round: 'r32', home: { kind: 'group_runner', group: 'K' }, away: { kind: 'group_runner', group: 'L' } },
  { matchNum: 84, round: 'r32', home: { kind: 'group_winner', group: 'G' }, away: { kind: 'third_slot', matchNum: 84 } },
  { matchNum: 85, round: 'r32', home: { kind: 'group_winner', group: 'H' }, away: { kind: 'group_runner', group: 'J' } },
  { matchNum: 86, round: 'r32', home: { kind: 'group_winner', group: 'K' }, away: { kind: 'third_slot', matchNum: 86 } },
  { matchNum: 87, round: 'r32', home: { kind: 'group_runner', group: 'D' }, away: { kind: 'group_runner', group: 'G' } },
  { matchNum: 88, round: 'r32', home: { kind: 'group_winner', group: 'J' }, away: { kind: 'group_runner', group: 'H' } },

  { matchNum: 89, round: 'r16', home: { kind: 'winner_of', matchNum: 76 }, away: { kind: 'winner_of', matchNum: 78 } },
  { matchNum: 90, round: 'r16', home: { kind: 'winner_of', matchNum: 73 }, away: { kind: 'winner_of', matchNum: 74 } },
  { matchNum: 91, round: 'r16', home: { kind: 'winner_of', matchNum: 75 }, away: { kind: 'winner_of', matchNum: 77 } },
  { matchNum: 92, round: 'r16', home: { kind: 'winner_of', matchNum: 79 }, away: { kind: 'winner_of', matchNum: 80 } },
  { matchNum: 93, round: 'r16', home: { kind: 'winner_of', matchNum: 83 }, away: { kind: 'winner_of', matchNum: 85 } },
  { matchNum: 94, round: 'r16', home: { kind: 'winner_of', matchNum: 82 }, away: { kind: 'winner_of', matchNum: 84 } },
  { matchNum: 95, round: 'r16', home: { kind: 'winner_of', matchNum: 88 }, away: { kind: 'winner_of', matchNum: 87 } },
  { matchNum: 96, round: 'r16', home: { kind: 'winner_of', matchNum: 81 }, away: { kind: 'winner_of', matchNum: 86 } },
